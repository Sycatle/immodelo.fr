...
export function StepLayout({
  ...
  return (
    <div className="relative w-full flex flex-col justify-between min-h-screen px-4 lg:px-6 bg-white lg:max-w-3xl">
      <header className="pt-20 pb-8">
        <h2 className="text-xl font-semibold text-gray-900">{title}</h2>
      </header>
      {/* on garde un padding bottom assez grand pour que le contenu ne soit pas masqué */}
      <div className="py-6 space-y-4 w-full">{children}</div>
